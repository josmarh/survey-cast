      ...
      <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input id="fullname" name="fullname" type="text" autocomplete="fullname" required="" v-model="user.name"
          ...
          <div>
            ...
            <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="current-password_confirmation" required="" 
              ...
              class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 
                ...
                focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Confirm Password" />
          </div>
        </div>
