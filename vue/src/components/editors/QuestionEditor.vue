<template>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 -mt-1 inline-block" 
    ...
    <div class="grid gap-3 grid-cols-12">
        ...
        <div class="mt-3 col-span-3">
            ...
            <select name="question_type" id="question_type" @change="typechange" v-model="model.type"
                class="block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none 
    ...
    <div>
        <div v-if="shouldHaveOptions()" class="mt-2">
            ...
            <!-- if data options does not exist  -->
...
// Re-create the whole question data to aviod unintentional reference change 
...
function shouldHaveOptions() {
    return ["select","redio","checkbox"].includes(model.value.type);
}
